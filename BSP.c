...
{   
    ...
    TIM2->ARR = (SystemCoreClock / 1000) * period - 1;  /* Set update value 
                                                           to period in ms  
                                                        */      
    NVIC_EnableIRQ(TIM2_IRQn);              /* Enable Interrupt in NVIC block */
...
{   
    ...
    NVIC_EnableIRQ(TIM3_IRQn);              /* Enable Interrupt in NVIC block */
...
{   
    ...
    TIM4->ARR = (SystemCoreClock / 1000) * period - 1;  /* Set update value 
                                                           to period in ms
                                                        */      
    NVIC_EnableIRQ(TIM4_IRQn);              /* Enable Interrupt in NVIC block */
